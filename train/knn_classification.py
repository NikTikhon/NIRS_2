import pandas as pd
import joblib
from classification.KNN import optimize_hyperparams, classify
...
hyper_params = [{'n_neighbors': [3, 5, 7, 9], 'weights': ['uniform', 'distance'], 'leaf_size': [30, 40, 50, 60]}]
hyper_params = [{'n_neighbors': [3], 'weights': ['uniform'], 'leaf_size': [30]}]
